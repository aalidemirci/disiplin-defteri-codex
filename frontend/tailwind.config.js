  ...
  theme: {
    extend: {
      colors: {
        ...
        scrim: color("scrim"),
        sidebar: "rgb(var(--dd-sidebar) / <alpha-value>)",
        "sidebar-raised": "rgb(var(--dd-sidebar-raised) / <alpha-value>)",
        "on-sidebar": "rgb(var(--dd-on-sidebar) / <alpha-value>)",
        "on-sidebar-muted": "rgb(var(--dd-on-sidebar-muted) / <alpha-value>)",
        "sidebar-active": "rgb(var(--dd-sidebar-active) / <alpha-value>)",
        success: "rgb(var(--dd-success) / <alpha-value>)",
        "success-container": "rgb(var(--dd-success-container) / <alpha-value>)",
        "on-success-container": "rgb(var(--dd-on-success-container) / <alpha-value>)",
