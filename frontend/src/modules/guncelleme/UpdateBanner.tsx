...
const DISMISSED_KEY = "disiplin-defteri-dismissed-update";
...
export default function UpdateBanner() {
  ...
  const download = async () => {
    ...
    try {
      ...
      saveBlob(blob, update.installer_name || `disiplin-defteri-${update.latest_version}.exe`);
  ...
  return (
    ...
    >
      ...
      <p className="min-w-48 flex-1 text-body-medium">
        <span className="font-medium">Disiplin Defteri {update.latest_version} hazır.</span> Çalışan
