...
const PAROLASIZ = {
  ...
  transition: "",
  protected_fields: ["TCKN", "veli adı", "veli telefonu"],
};
...
describe("GuvenlikAyarlari", () => {
  ...
  it("parolasız durumda dürüst kapsam metnini ve korunan alanları gösterir", async () => {
    ...
    expect(screen.getByText(/TCKN, veli adı, veli telefonu/)).toBeInTheDocument();
    // Şifrelenmeyen alanlar da açıkça söylenir.
    expect(screen.getByText(/ad-soyadı, okul numarası ve sınıf/)).toBeInTheDocument();
  });
