// Kurulum kapısı (F4-D4) — programın İLK açılışında kullanıcıyı kurulum
// sihirbazına kilitler. Disiplin Defteri authsuz olduğu için "giriş ekranı" yoktur;
// kapıyı açan tek koşul kurulumun tamamlanmış olmasıdır: okul künyesi girilmeden
// resmî evrak antedi boş çıkar, aktif ders yılı ve tatil takvimi olmadan da yasal
// süre (iş günü) hesabı yanlış olur. Bu yüzden `GET /setup/status/`
