...
export default function DensitySwitcher({
  ...
  return (
    <button
      ...
      className={`group relative flex min-h-[var(--dd-control-height)] items-center overflow-hidden rounded-shape-md text-label-large text-on-surface-variant transition hover:bg-on-surface/8 hover:text-on-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
