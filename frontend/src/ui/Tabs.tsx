      ...
      {items.map((item, idx) => {
        ...
        return (
          <button
            ...
            className={`relative flex h-[var(--dd-control-height)] shrink-0 items-center gap-2 whitespace-nowrap rounded-shape-sm px-3 text-label-large transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary ${
              isActive
