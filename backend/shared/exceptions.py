...
# ("No DisciplineDecisionType matches the given query."). Sözleşme Türkçe mesaj
# ister; view'ın kendi verdiği Türkçe detay ("Ek bulunamadı.") korunur.
...
def dd_exception_handler(exc: Exception, context: dict[str, Any]) -> Response | None:
