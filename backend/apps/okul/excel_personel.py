...
tanımlanır. Fuzzy başlık eşleme kalıbı (excel_veli deseni) aynen korunur.
...
from apps.okul.excel_veli import ParserError, normalize_header, read_sheet
...
# read_sheet excel_veli'den yeniden kullanılır (etkin sayfa, salt-okunur).
__all__ = [
    "ParsedPersonnelRow",
