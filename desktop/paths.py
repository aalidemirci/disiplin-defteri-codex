...
# Dizin adı — tasarım §10.3 "Tamamlayıcı Kararlar/3: Veri dizini adı DisiplinDefteri".
# (§5.3'teki `OkulDisiplin` daha eski bir taslak adıdır; §10 sonradan kesinleşen
# kararları taşıdığı için o kazanır. Ad değişirse YALNIZ bu iki sabit değişir.)
APP_DIR_NAME_WINDOWS = "DisiplinDefteri"
APP_DIR_NAME_XDG = "disiplin-defteri"

# Tüm yerleşimi tek hamlede geçersiz kılar (test, CI, `--autotest`, taşınabilir kip).
ENV_APP_HOME = "DD_APP_HOME"
# Django kodunun bulunduğu dizin (paket içinde exe'nin yanında).
ENV_BACKEND_DIR = "DD_BACKEND_DIR"
