...
@pytest.mark.parametrize(
    "yol",
    [
        r"C:\Users\ali\OneDrive\Belgeler\DisiplinDefteri",
        r"C:\Users\ali\AppData\Roaming\DisiplinDefteri",
        "/home/ali/Dropbox/disiplin-defteri",
    ],
)
...
def test_senkron_disi_dizin_uyari_vermez() -> None:
    assert check_sync_hazard(Path(r"C:\Users\ali\AppData\Local\DisiplinDefteri")) is None
...
def test_backend_dizini_env_ile_gecersiz_kilinir(tmp_path: Path) -> None:
    ...
    assert resolve_backend_dir(environ={"DD_BACKEND_DIR": str(sahte)}) == sahte
