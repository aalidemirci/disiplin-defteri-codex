...
logger = logging.getLogger("disiplin_defteri.window")

WINDOW_TITLE = "Disiplin Defteri"
WINDOW_WIDTH = 1280
WINDOW_HEIGHT = 860
WINDOW_MIN_SIZE = (1024, 700)
WINDOW_ICON_FILE = "disiplin-defteri.ico"
WINDOW_APP_ID = "DisiplinDefteri.Desktop"
