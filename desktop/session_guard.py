...
Middleware `config/settings.py`'ye YALNIZ `DD_SESSION_TOKEN` doluyken eklenir;
...
ENV_TOKEN = "DD_SESSION_TOKEN"  # noqa: S105
SESSION_COOKIE_NAME = "dd_oturum"
TOKEN_QUERY_PARAM = "t"  # noqa: S105
# Django'nun WSGI/`HttpRequest.META` biçimi: `X-DD-Token` başlığı.
TOKEN_HEADER = "HTTP_X_DD_TOKEN"  # noqa: S105
