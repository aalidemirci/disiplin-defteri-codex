...
çıkarır. Görüntü diske yalnız `.ddbak` şifreli kapsayıcısı olarak yazılır.
...
logger = logging.getLogger("disiplin_defteri.backup")
...
def encrypt_legacy_backups(backup_dir: Path, data_dir: Path) -> list[Path]:
    """Eski düz SQLite yedeklerini atomik olarak şifreli `.ddbak` biçimine çevirir."""
