...
veri dizini `DD_DATA_DIR` ile settings'e bildirilir. Django içe aktarmaları
...
logger = logging.getLogger("disiplin_defteri.django")

SETTINGS_MODULE = "config.settings"
ENV_DATA_DIR = "DD_DATA_DIR"
...
def prepare_django(backend_dir: Path, data_dir: Path) -> None:
    ...
    ÖNEMLİ: bu çağrıdan ÖNCE `DD_SESSION_TOKEN` ayarlanmış olmalıdır — ayar
...
def assert_session_guard_installed() -> None:
    ...
    `DD_SESSION_TOKEN` ayarlandığı hâlde middleware yüklenmemişse (ayar dosyası
