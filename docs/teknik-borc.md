...
| M3 | **md. 180 onur kurulu kompozisyonu:** sınıf seviyesi / ikinci başkan kompozisyonu doğrulanmıyor (md. 181 üyelik düşmesi kısmı 26.09.2026'da kapandı — aşağıda) | Model değişikliği + UI |
