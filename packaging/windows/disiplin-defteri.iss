; =============================================================================
;  disiplin-defteri.iss — Inno Setup kurulum betiği (Windows)
; =============================================================================
...
;         /DSourceDir=...\dist\paket\disiplin-defteri /DOutputDir=...\dist\cikti ^
;         packaging\windows\disiplin-defteri.iss
; =============================================================================
...
#endif
#ifndef SourceDir
  #define SourceDir "..\..\dist\paket\disiplin-defteri"
#endif
#ifndef OutputDir
  #define OutputDir "..\..\dist\cikti"
#endif

#define AppName "Disiplin Defteri"
#define AppExeName "disiplin-defteri.exe"
#define AppUserModelId "DisiplinDefteri.Desktop"
#define AppIconSource "..\ikonlar\disiplin-defteri.ico"
#define InstalledIconName "disiplin-defteri-" + AppVersion + ".ico"
#define WebView2Setup "MicrosoftEdgeWebView2Setup.exe"

[Setup]
; AppId ASLA DEĞİŞMEZ — değişirse yükseltmeler yan yana kurulur.
AppId={{F0ACB44A-3414-48D8-B7BA-0A262613A3D1}
AppName={#AppName}
AppVersion={#AppVersion}
AppVerName={#AppName} {#AppVersion}
VersionInfoVersion={#NumericVersion}
AppPublisher=Disiplin Defteri
...
OutputDir={#OutputDir}
OutputBaseFilename=disiplin-defteri-{#AppVersion}-win64-setup
...
AppMutex=DisiplinDefteriKurulum
...
Type: files; Name: "{app}\disiplin-defteri-*.ico"
...
[Messages]
turkish.FinishedLabel=Kurulum tamamlandı.%n%nVerileriniz (disiplin kayıtları ve yedekler) programın kurulduğu klasörde DEĞİL, kullanıcı klasörünüzde saklanır. Programı kaldırsanız bile kayıtlarınız silinmez.
