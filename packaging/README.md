...
│   ├── disiplin-defteri.desktop menü kaydı
...
└── windows/
    ...
    ├── disiplin-defteri.iss     Inno Setup (yönetici GEREKTİRMEZ)
...
* **Qt penceresinin gerçekten açılması.** İlk Pardus koşusunda `disiplin-defteri`
...
import ediyorsa `disiplin_defteri.spec` içindeki `hiddenimports` listesine de
